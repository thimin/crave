...
export const products: Product[] = [
  {
    id: 1,
    name: "Cloud Blossom - Marshmallow Flower Bouquet",
  ...
  {
    id: 2,
    name: "Midnight Velvet - Chocolate-Coated Strawberry Basket",
    ...
    image: "/images/strawberry-tower.jpeg",
    variations: [
      { name: "Dark Chocolate Coated", price: 11500 },
  ...
  {
    id: 3,
    name: "Candy Carnival Bloom – Mix Candy Massive Bouquet",
    ...
    variations: [
      { name: "Mixed", price: 10500 },
    ]
  },
  {
    id: 4,
    name: "Citrus Kiss – Fruit-Flavored Candy Bouquet",
    ...
    variations: [
      { name: "Mixed Fruit Flavors", price: 7900, description: "Strawberry, orange, pineapple, tamarind, passion fruit & more" },
    ]
  },
  {
    id: 5,
    name: "Sweet Celebration Pops – Cake Pops Bouquet",
    description: "Delicious cake pops arranged in a stunning bouquet. Includes 100 cake pops.",
    image: "/images/cake-pops.jpeg",
    variations: [
      { name: "Butter Cake Pops", price: 12700 },
  ...
  {
    id: 6,
    name: "Berry Bliss – Strawberry & Brownie Mix Basket",
    description: "Half decadent fudgy brownies + half fresh berries dipped in chocolate (50:50).",
    image: "/images/berry-brownie.jpeg",
    variations: [
      { name: "Berry + Brownie Mix", price: 11800 },
    ]
  },
  {
    id: 7,
    name: "Romance Duo Basket – Roses & Chocolate Strawberries",
  ...
  },
  {
    ...
    variations: [
      { name: "Mixed Fresh Fruits", price: 19300, description: "Grapes, strawberries, orange, apple, kiwi, pomegranate & more" },
    ]
  },
  {
    id: 9,
    name: "Sugar Bloom Deluxe – Sugar Cookie Bouquet",
    ...
    variations: [
      { name: "Decorated Sugar Cookies", price: 9500 },
    ]
  },
  {
    id: 10,
    name: "Golden Anniversary Luxe – Chocolate Bouquet",
    description: "Premium luxury mix of Ferrero Rocher, chocolate bars, caramel clusters, and more. Includes 60 items.",
    image: "/images/golden-luxe.jpeg",
    variations: [
      { name: "Luxury Chocolates & Sweets", price: 13600 },
    ]
  },
  {
    id: 11,
    name: "Spice & Nostalgia – Achcharu (Pickle) Basket",
    ...
    image: "/images/pickle-balls.jpeg",
    variations: [
      { name: "6 Different Sri Lankan Pickles", price: 14000 },
    ]
  },
  {
    id: 12,
    name: "Parisian Love – Macaron & Roses Basket",
    description: "Colorful French macarons in 5 flavors + fresh roses (25:25).",
    image: "/images/macaron-roses.jpeg",
    variations: [
      { name: "Mixed Macaron Flavors + Roses", price: 12400 },
    ]
  },
  {
    id: 13,
